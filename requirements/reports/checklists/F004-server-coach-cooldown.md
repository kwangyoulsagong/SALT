...
| 항목 | 사유 | 언제 닫히나 |
|---|---|---|
| ~~인증된 HTTP 202 · 429~~ | — | **2026-09-23 닫힘** — BFF 슬라이스 14 에서 실제 로그인 토큰으로 BFF 경유 실측 |
| ~~BFF 의 `Retry-After` 전달~~ | 본문 `retryAfterSeconds` 가 빠지고 있었다 — BFF 슬라이스 14 가 고쳤다 | **2026-09-23 닫힘** |
