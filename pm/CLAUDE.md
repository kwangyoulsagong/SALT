...
- 기능 기획 작업 전 `pm/.claude/rules/feature-planning.md`를 읽는다.
...
- `.claude/rules/feature-planning.md` — 기능 기획서 작성/업데이트 규칙
- `.claude/rules/feature-inventory.md` — 전체 기능 파악과 기능 맵 유지 규칙
- `.claude/rules/traceability.md` — 화면/API/DB/worker 추적 규칙
- `.claude/rules/prototype-design.md` — PM React 프로토타입/더미 계약/디자인 규칙
