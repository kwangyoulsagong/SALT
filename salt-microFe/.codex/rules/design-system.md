...
- `@repo/ui` 패키지 로컬 규칙: `packages/ui/AGENTS.md`
- `@repo/ui` 패키지 Codex 규칙: `packages/ui/.codex/rules/design-system.md`
- `@repo/ui` Storybook 작성 규칙: `packages/ui/.codex/rules/storybook.md`
- 실제 구현: `packages/ui/**`
...
- Storybook story는 `packages/ui/.codex/rules/storybook.md`를 따른다.
