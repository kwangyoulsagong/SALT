...
!`cat salt-microFe/.codex/rules/study-report.md`
!`cat salt-microFe/.codex/rules/requirements-management.md`
...
- Multi-Zones: [Guides: Multi-zones — Next.js](https://nextjs.org/docs/app/guides/multi-zones)
- Vercel Microfrontends: [Vercel Microfrontends](https://vercel.com/docs/microfrontends)
