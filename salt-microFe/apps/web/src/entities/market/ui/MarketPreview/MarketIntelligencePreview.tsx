...
import {
  ...
  SentimentText,
  SmartMoneyMessage,
} from "./MarketIntelligencePreview.css";
import { Root } from "@repo/ui/root";
import { Text } from "@repo/ui/text";

import { vars } from "@/shared/ui/tokens.css";

import { useMarketIntelligencePreview } from "../../api";
...
export const MarketIntelligencePreview = React.memo(
  ({ symbol }: MarketIntelligencePreviewProps) => {
    ...
    const { data, isLoading, isError } = useMarketIntelligencePreview(symbol);
      ...
      <Root width="full">
        <FlexBox direction="column" gap="4xl">
          <Section padding="none" noContainer>
            <FlexBox direction="column" gap="xl">
              <Heading level={5} color="tertiary">
                {MARKET_MESSAGES.sentimentHeading}
              </Heading>
              <FlexBox
                direction="row"
                justify="between"
          ...
          <Section padding="none" noContainer>
            <FlexBox direction="column" gap="xl">
              <Heading level={5} color="tertiary">
                {MARKET_MESSAGES.smartMoneyHeading}
              </Heading>
              <FlexBox direction="row" align="center" gap="xl">
                ...
                <FlexBox direction="column" gap="lg">
                  ...
                  >
                    <Heading level={6} color="tertiary">
                      {MARKET_MESSAGES.orderbookRatio}
                    </Heading>
          ...
          <Section padding="none" noContainer>
            <FlexBox direction="column" gap="xl">
              <Heading level={5} color="tertiary">
                {MARKET_MESSAGES.newsHeading}
              </Heading>
              <MarketNewsPreview symbol={symbol} />
            </FlexBox>
          </Section>
        </FlexBox>
      </Root>
