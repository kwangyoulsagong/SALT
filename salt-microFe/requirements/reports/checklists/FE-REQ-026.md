...
## 9. F009 슬라이스 0 — C05 유효시간 문구 (FR-164, 2026-09-24)

| FR | 판정 | 근거 |
|---|---|---|
| FR-164 | **pass** | `messages.ts` `validity` 두 키. 웹 소스에 `5m_24h` · `1w_1y` 0건 |
| 게이트 | **pass** | `pnpm check-types` · `lint` · `test` · `build`(web · web-tax) · `layer-check` |
