...
| `GET /api/app/plan/monthly-summary` | 100ms | 서버 50ms (2026-09-21 — B20) |
...
| 이번 달 적립 합계 (2026-09-21) | **캐시하지 않는다.** 체크 직후 값이 바로 보여야 한다 |
...
- [ ] 로그에 금액이 0건이다 (월 적립액 `monthlyBaseKrw` 포함 — 2026-09-21)
- [ ] `GET /api/app/plan/monthly-summary` p95 < 100ms이고 BFF 캐시가 0건이다 (B20)
...
| 날짜 | 변경 |
|---|---|
| 2026-09-21 | `pm/requirements/reports/feature-audits/2026-09-21-storyboard-gap.md` 반영. 이번 달 적립 합계 예산·캐시 정책 추가(B20), 로그 금액 금지에 월 적립액 포함(D9) |
